 ...
 */
export type SipApiClientGetSipConfigurationResponse = SipConfiguration & {
  /**
 ...
 * Optional parameters.
 */
export interface SipApiClientPatchSipConfigurationOptionalParams
  extends coreHttp.OperationOptions {
  /**
   * Configuration patch.
   */
  body?: SipConfiguration;
}

/**
 * Contains response data for the patchSipConfiguration operation.
 */
export type SipApiClientPatchSipConfigurationResponse = SipConfiguration & {
  /**
   * The underlying HTTP response.
   */
  _response: coreHttp.HttpResponse & {
 ...
 * Optional parameters.
 */
export interface SipApiClientOptionalParams
