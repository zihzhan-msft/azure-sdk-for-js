...
export class SasTokenPartitionKeyValueRange implements SasTokenPartitionKeyValueRangeInterface {
  ...
  // public decode(encoding: string): SasTokenPartitionKeyValueRange {
  //   const decodedString: number[] = encodeBase64(encoding); decode
  //   return new SasTokenPartitionKeyValueRange(encodeURIComponent(decodedString.toString()));
  // }
}
